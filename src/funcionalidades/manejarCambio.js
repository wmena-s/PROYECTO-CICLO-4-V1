...
class manejarCambios extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            equipo: {
    ...
    async componentDidMount() {
        // Obtener ID de URL
        const idEquipo = this.props.match.params.id;
        // Llamar a la API para obtener los detalles
        const respuesta = await fetch(`${Constantes.RUTA_API}/${idEquipo}`);
...
export default withRouter(manejarCambios);

...
Únicamente pueden ser registrados por su servidor de Internet en el dominio que le emitió́ el cookie. Los cookies no pueden ser utilizados para operar programas o ingresar virus a su computadora.

Usamos cookies para obtener información no personal de visitantes en línea. Los cookies rastrean el tipo de navegador, sistema operativo y prestador de servicios de Internet y nos permiten tabular el número total de visitantes en nuestra página. Usted puede desactivar el cookie en su computadora o programarla para avisarle cuando se le envían cookies mediante el icono de preferencias de su navegador.

Es responsabilidad del Titular de los Datos Personales el garantizar que los Datos facilitados a EL DEPORTIVO sean veraces y completos, así́ como comunicar a EL DEPORTIVO cualquier modificación en los mismos a efecto de que se pueda cumplir con la obligación de mantener la información actualizada.

¿Cómo contactarnos?

A través de nuestro correo electrónico prensa@eldeportivo.com.co

En nuestras oficina Principal: Carrera 47 # 93-62 , Bogotá, D.C., Colombia.</p>
        </div>
    )
}

export default PoliticasDos
